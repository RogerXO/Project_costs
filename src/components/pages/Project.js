...
function Project() {
  ...
  useEffect(() => {
    setTimeout(() => {
      fetch(`https://costs-server-api.onrender.com/projects/${id}`, {
        method: "GET",
        headers: {
  ...
  function editPost(project) {
    ...
    fetch(`https://costs-server-api.onrender.com/projects/${project.id}`, {
      method: "PATCH",
      headers: {
        "Content-type": "application/json",
      },
  ...
  function removeService(id, cost) {
    ...
    fetch(`https://costs-server-api.onrender.com/projects/${projectUpdated.id}`, {
      method: "PATCH",
      headers: {
        "Content-type": "application/json",
      },
